...
"use strict";
(function leftSidebarSearchFilter() {

    let input = document.getElementById('left-sidebar__searchFilter');
    let suggestions = document.getElementsByClassName("left-sidebar__searchFilter-suggestions")[0];
    ...
    function searchQuery(){
        ...
        input = document.getElementById('left-sidebar__searchFilter');
        filter = input.value;
        ul_toc = document.getElementsByClassName("lhs-tree-menu-toc")[0];
        li_toc = ul_toc.getElementsByClassName("none");
        ul_suggestions = document.getElementsByClassName("left-sidebar__searchFilter-suggestions")[0];
        ...
        if(filter.trim()){
            ...
            for (i = 0; i < li_toc.length; i++) {
                ...
                if (matchWordsPartial(txtValue, textArray).length > 0) {  
                    ...
                    li_suggestion.classList.add("left-sidebar__searchFilter-suggestion");

                    // Parent span element
                    let span = document.createElement("SPAN");
                    span.className = ("is-block is-size-8 has-padding-left-small has-padding-right-small");
                    ...
                    span.appendChild(link);
                        ...
                        let span3 = document.createElement("SPAN");
                            span3.className = ("is-block has-text-subtle has-overflow-ellipsis is-size-9 has-line-height-reset has-padding-bottom-extra-small");
                            ...
                            while(true){
                                if (immediateParent.parentElement.classList.contains('lhs-tree-menu-toc')) break;
                            ...
                            span4.setAttribute("style", "font-size: 1.12rem; font-weight: bold");
...
let leftSidebarSearchFilter;
document.addEventListener('DOMContentLoaded', leftSidebarSearchFilter);